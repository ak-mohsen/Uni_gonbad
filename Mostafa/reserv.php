...
if ($mo2>0)
  {
    ...
    $query1="insert into rezerv(vorod,out,fm,name,mobile,email,suitmulti,suit,val) values ('$x','$x2','$x3','$x4','$x5','$x6','$x7','$mo1','رزرو')";
    $result1=mysql_query($query1);
    echo "<script>alert('$x5 کد رزرو');  </script><meta http-equiv=refresh content=0;url=index.php>";
    }
  }
    if(isset($_POST['submit']))
    {
...
?>
<? $ra=rand(1, 1000000); ?>
<form name="form1" onsubmit="return xx();" action="reserv.php" method="post">
<input name="formtext3" type="hidden" value=<?php echo $ra ?> ><? echo $ra; ?>&nbsp;&nbsp;:کد پيگيري رزرو <br />
