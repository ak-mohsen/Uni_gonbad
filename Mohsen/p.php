...
<TR valign=top>
<TD><FONT style="font-size:10pt" color=#000000 face="Tahoma">
<DIV align=center><?php echo $row1['val']; ?></DIV>
</FONT>
</TD>
<TD><FONT style="font-size:10pt" color=#000000 face="Tahoma">
<DIV align=center><?php echo $row1['suit']; ?></DIV>
</FONT>
</TD>
<TD><FONT style="font-size:10pt" color=#000000 face="Tahoma">
<DIV align=center><?php echo $row1['suitmulti']; ?></DIV>
</FONT>
</TD>
<TD><FONT style="font-size:10pt" color=#000000 face="Tahoma">
<DIV align=center><?php echo $row1['out']; ?></DIV>
</FONT>
</TD>
<TD><FONT style="font-size:10pt" color=#000000 face="Tahoma">
<DIV align=center><?php echo $row1['vorod']; ?></DIV>
</FONT>

</TD>
<TD><FONT style="font-size:10pt" color=#000000 face="Tahoma">
<DIV align=center><?php echo $row1['email']; ?></DIV>
</FONT>
</TD>
<TD><FONT style="font-size:10pt" color=#000000 face="Tahoma">
<DIV align=center><?php echo $row1['mobile']; ?></DIV>
</FONT>
</TD>
<TD><FONT style="font-size:10pt" color=#000000 face="Tahoma">
<DIV align=center><?php echo $row1['name']; ?></DIV>
</FONT>
</TD>
<TD><FONT style="font-size:10pt" color=#000000 face="Tahoma">
<DIV align=center><?php echo $row1['fm']; ?></DIV>
</FONT>
</TD>
</TR>
</TABLE>
...
<? }
   ...
   ?>
<form name="" action="p.php" method="post">
 <input name="sh" type="text" value=""><br />
 <input type="submit" value="بررسي">
</form>
<br /> <br />
